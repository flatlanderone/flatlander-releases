...
## Overview
**Tier 1 Melee Weapons As Intro Buried Supplies Rewards** changes the rewards for completing the Intro Buried Supplies quest. Instead of Tier 0 pipe weapons and ammo, you choose a Tier 1 melee weapon (Baseball Bat, Hunting Knife, Iron Knuckles, Iron Spear, Iron Sledgehammer).
...
## Manual installation
 ...
 3. Copy the **T1MeleeWeaponsAsIBSRewardFLTR** folder to the 7 Days to Die Mods folder. The default location is **%APPDATA%\7DaysToDie\Mods**.
...
## About this mod
 ...
 - **Download page**: [Tier 1 Melee Weapons As Intro Buried Supplies Rewards](https://www.nexusmods.com/7daystodie/mods/9900)
